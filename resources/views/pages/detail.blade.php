      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="owner">By Cahyono</div>
            <div class="price">$1,987</div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <p>
            ...
            comfort while transparent mesh and vibrantly coloured details on
            the upper are blended with timeless OG features for an edgy,
            modernised look.
          </p>
        </div>
      </div>
